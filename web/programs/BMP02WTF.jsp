            ...
            <div class="row shadow">
                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2">
                    ...
                    <select class="form-control form-control-user" name="vType" id="vType">
                        ...
                        <option value="SCB">SCB WTF </option>
                        <!--<option value="KBANK">KBANK</option>-->
                        <option value="BBL">BBL WTF</option>
                        <option disabled>────────────────────────</option>
<!--                        <option value="SCB_BILL">SCB (Bill Payment)</option>
                ...
                <div class="col-xs-2 col-sm-3 col-md-3 col-lg-2">
                    ...
                    <button id="vSearch" class="form-control btn-info">Search</button>
                </div>
            </div>
            <hr>
            <div class="row">
...
//                            }
                            ...
                            if (item.BM_FNNO !== "-") { 
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_SCBnewWTF";
                                } else {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_SCBnewWTF";
                                } else {
                                    item.page = "updateAccont";
                                }
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "updateReceipt_BBLnewWTF";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "createReceipt_BBLnewWTF";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
