                ...
                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2">
                    ...
                    <select class="form-control form-control-user" name="vType" id="vType">
                        ...
                        <option value="BBL_CUR">BBL (Current)</option>
                         <option disabled>────────────────────────</option>
                          <option value="BBL_QR">BBL (Bill Payment QR CODE)</option>
                           <option disabled>────────────────────────</option>
                    </select>
                </div>
...
//            console.log(rctype);
            ...
            } else if (type === "SCB_CUR") {
                getGrid_SCB_CUR(date, "SCB_CUR");
            } else if (type === "KBANK_CUR") {
                getGrid_KBANK_CUR(date, "KBANK_CUR");
            } else if (type === "BBL_CUR") {
                getGrid_BBL_CUR(date, "BBL_CUR");
            }
             else if (type === "BBL_QR") {
                getGrid_BBL_QR(date, "BBL_QR");
            }
            else {
        ...
        const Type = [
            ...
            {Name: "DEPOSIT", Id: "TRANSFER_DEPOSIT"}
...
//                    $("#grid").jsGrid("loadData");
                ...
                controller: {
                        ...
                        $.ajax({
                            ...
                            response = $.grep(response, function (item) {
                                return(!filter.BM_ACCODE || (item.BM_ACCODE.indexOf(filter.BM_ACCODE) > -1))
                                        ...
                                        && (!filter.BM_FNNO || (item.BM_FNNO.indexOf(filter.BM_FNNO) > -1))
                    ...
                    updateItem: function (item) {
                        ...
                        if (item.HPYNO !== "" && (item.HPYNO.indexOf("TH") !== 0 && item.HPYNO.indexOf("th") !== 0 && item.HPYNO.indexOf("Th") !== 0 && item.HPYNO.indexOf("tH") !== 0)) {

                            item.HPYNO = "TH" + item.HPYNO;
                        }


                        if (CHKCUORPY(item.HPYNO) == "OK") {
...
//                            }
                            ...
                            if (item.BM_FNNO !== "-") {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_SCBnew";
                                } else {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_SCBnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            ...
                            alert("PAYER CODE ไม่ตรงกับฐานข้อมูล กรุณาตรวจสอบแล้วลองใหม่อีกครั้ง");
                            item.cancel = true;
                            $("#grid").jsGrid("loadData");
                    ...
                    updateItem: function (item) {
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_KBANKnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_KBANKnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "updateReceipt_BBLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "createReceipt_BBLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
////////////////////////// CURRENT //////////////////////////
 ...
 function getGrid_SCB_CUR(date, bank, rctype) {
            $("#grid").jsGrid({
                width: "100%",
                height: "700",
                filtering: true,
                    ...
                    updateItem: function (item) {
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_SCB_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_SCB_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
...
//                    {title: "Receipt", name: "HC_RCNO", type: "text", align: "center", editing: false},
        ...
        function getGrid_KBANK_CUR(date, bank) {
            $("#grid").jsGrid({
                width: "100%",
                height: "700",
                filtering: true,
                    ...
                    updateItem: function (item) {
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_KBANK_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_KBANK_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
//                    {title: "Receipt", name: "BM_RCNO", type: "text", align: "center", editing: false},
        ...
        function getGrid_BBL_QR(date, bank) {
            $("#grid").jsGrid({
                width: "100%",
                height: "700",
                filtering: true,
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "updateReceipt_BBL_QRnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "createReceipt_BBL_QRnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
//                    }
                ...
                fields: [
                    ...
                    {title: "Date", name: "BM_DATE", type: "text", align: "center", editing: false},
                    {title: "Time", name: "BM_TIME", type: "text", align: "center", editing: false},
                    {title: "REF1", name: "BM_REFCU1", type: "text", align: "center", editing: false},
                    {title: "REF2", name: "REF2", type: "text", align: "center", editing: false},
                    {title: "Amount", name: "BM_AMOUNT", type: "number", align: "right", editing: false, itemTemplate: function (value) {
                            return  value.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,');
                        }},
                    {title: "PAYER", name: "HPYNO", type: "text", align: "center", editing: true},
...
//                    {title: "Receipt", name: "BM_RCNO", type: "text", align: "center", editing: false},
        ...
        function getGrid_BBL_CUR(date, bank) {
            $("#grid").jsGrid({
                width: "100%",
                height: "700",
                filtering: true,
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "updateReceipt_BBL_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    ...
                                    item.page = "createReceipt_BBL_CURnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
                ...
                controller: {
                    ...
                    updateItem: function (item) {
                        ...
                        if (CHKCUORPY(item.HPYNO) == "OK") {
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_SCB_RBILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_SCB_RBILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
//                        else{
                            ...
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_SCB_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            } else {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_SCB_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
//                        else{
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_KBANK_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            } else {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_KBANK_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
//                        else{
                            if (item.BM_FNNO !== "-") {
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "updateReceipt_BBL_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                                ...
                                if (item.BM_LOCA !== "ACCOUNT") {
                                    item.page = "createReceipt_BBL_BILLnew";
                                } else {
                                    item.page = "updateAccont";
                                }
                            }
...
//                    {title: "Receipt", name: "BM_RCNO", type: "text", align: "center", editing: false},
        ...
        function CHKCUORPY(TXT) {

            var cono1 = <%out.print(session.getAttribute("cono"));%>;
            var rr = "NG";
            $.ajax({
                type: "GET",
                url: "./Sync",
