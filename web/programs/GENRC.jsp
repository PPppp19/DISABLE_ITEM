                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                         ...
                                         <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="cash_EXP" value="CASH_EXP" onclick="radiobtn()">&nbsp;<label class="control-label">CASH_EXP</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="transfer_EXP" value="TRANSFER_EXP" onclick="radiobtn()">&nbsp;<label class="control-label">TRANSFER_EXP</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="check_EXP" value="CHECK_EXP" onclick="radiobtn()">&nbsp;<label class="control-label">CHECK_EXP</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row " >
                                <div class="col-xs-8 col-sm-6 col-md-6 col-lg-4">
                                    <label style="width: 100%">Customer No. :
                                        <input type="text" class="form-control text-center"  value="" id="vCus" name="vCus" >
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-6 col-lg-2">
                                    <label>Location :
                                        <input type="text" class="form-control text-center"  value="" id="vLoc" name="vLoc" maxlength="8" >
                                    </label>
                                </div>
                                <br>
                                <div class="col-xs-8 col-sm-6 col-md-6 col-lg-4">
...
//                        Call_GridReceipt();
                ...
                fields: [
                    ...
                    {title: "Amount Receive", name: "RECEIVE", type: "text", align: "right", editing: false, filtering: false,
                        itemTemplate: function (value) {
                            return  value.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,');
                        }, width: 40}
//                            ,{title: "Remark", name: "Remark", type: "text", align: "left", filtering: false, editing: true}
        ...
        function Getrcno() {
            ...
            var locations = document.getElementById("vLoc").value;
            ;
            if ($("#vTRDT").val() === "" || $("#vPAYER").val().length < 10) {
                alert("Please check data !!");
                return;
...
//        });
        ...
        $('#vSearch').click(function (e) {
            ...
            $.ajax({
                ...
                $.each(response, function (i, obj) {
                    document.getElementById('vCus').value = obj.H_CUNO;
                    document.getElementById('vRCNO').value = obj.H_RCNO;
                    document.getElementById('vPAYER').value = obj.H_PYNO;
                    SearchPY(obj.H_PYNO);
                });
//
//
