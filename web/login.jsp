                ...
                <form class="login100-form validate-form" action="Login" method="POST">
                    ...
                    <div class="container-login100-form-btn">
                      ...
                      <div class="form-group">
                            <div style="width: 140px;">
                                <a href="#" onclick="window.open('http://192.200.9.94:8080/BankMapping/BANK_MAPPING_PROGRAM_MANUAL.pdf', '_blank', 'fullscreen=yes'); return true;" ><li style="color: blue;"><u>คู่มือการใช้งานโปรแกรม_BANK_MAPPING_PROGRAM_MANUAL</u></li></a>        
                            </div>  
                        </div>
...
//                              location.replace("http://192.200.9.106:8080/BankMapping/login.jsp");
